...
def make_stub(cfg: ForecastConfig | None = None) -> Tuple[List[Transaction], List[Project]]:
    ...
    projects = [
        Project("PRJ-118", "Heeze", "Gemeente Haarlem", "government",
        ...
        Project("PRJ-204", "Brunssum", "Bouwbedrijf Y", "enterprise",
        ...
        Project("PRJ-091", "Heeze", "Gemeente X", "government",
    ...
    transactions = [
        ...
        txn("snel-x", "snelstart", "snel_export.csv", 99, "Brunssum", 2,
        ...
        txn("gilde-15", "gilde", "gilde_bank.csv", 15, "Heeze", -2,
